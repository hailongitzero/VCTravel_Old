    ...
    <div class="login-popup-wrap">
        ...
        <div class="login-content">
            ...
            <div class="remember">
                ...
                </div><a href="index.html#">Forgot Password ?</a>
            </div><a href="index.html#" class="cws-button gray alt full-width mt-20">Login now</a>
        </div>
        <div class="login-bot">
            <p>No account yet? <a href="index.html#">Register now</a></p>
        </div>
    </div>
</div>
<!-- ! login popup-->